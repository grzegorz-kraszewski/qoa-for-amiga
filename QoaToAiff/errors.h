...
#define E_QOA_VARIABLE_CHANNELS       10    /* variable channels frame detected */
#define E_QOA_VARIABLE_SAMPLING       11    /* variable sampling rate frame detected */
#define E_QOA_ZERO_SAMPLES_FRAME      12    /* frame with zero samples specified */
#define E_QOA_TOO_MANY_SAMPLES        13    /* too many samples in a frame specified */
#define E_QOA_WRONG_FRAME_SIZE        14    /* specified frame size different from calculated */
